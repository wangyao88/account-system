...
<nav id="sidebar" role="navigation" class="navbar-default navbar-static-side">
    <div class="sidebar-collapse menu-scroll">
        <ul id="side-menu" class="nav">
            ...
            <li class="active"><a href="#"><i class="fa fa-slack fa-fw"><div class="icon-bg bg-green"></div></i><span class="menu-title">记账管理</span></a>
            	<ul class="nav nav-second-level">
                    <li><a href="tally/index"><i class="fa fa-chain"></i><span class="submenu-title">记账</span></a>
                    </li>
                    <li class="active"><a href="tally/list"><i class="fa fa-group"></i><span class="submenu-title">查账</span></a>
                    </li>
                </ul>
            </li>
